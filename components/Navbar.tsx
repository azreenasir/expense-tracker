        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold  bg-clip-text text-gray-900 dark:text-gray-100">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <div className="hidden sm:block">
              <SignedOut>
                <SignInButton>
                  <button className="relative overflow-hidden text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold shadow-lg border-1">
              ...
              <SignedIn>
                <div className="p-0.5 sm:p-1 rounded-lg sm:rounded-xl bg-gradient-to-r from-gray-100/50 to-white-100/50 dark:from-gray-900/20 dark:to-gray-900/20 backdrop-blur-sm border border-gray-200/30 dark:border-gray-700/30">
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
                          "w-6 h-6 sm:w-8 sm:h-8 hover:scale-110 transition-transform duration-200 bg-dark",
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg">
            ...
            <div className="pt-3 border-t border-gray-200/50 dark:border-gray-600/50">
              <SignedOut>
                <SignInButton>
                  <button
                    className="w-full text-white px-4 py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 active:scale-95"
                    onClick={closeMobileMenu}
                  >
                    <span>Sign In</span>
                    <svg
